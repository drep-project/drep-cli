...
func GenerateNoncePair(curve *secp256k1.KoblitzCurve, msg []byte, privkey *secp256k1.PrivateKey, extra []byte, version []byte) (*secp256k1.PrivateKey, *secp256k1.PublicKey, error) {
	priv, pubNonce, err := generateNoncePair(msg, privkey.Serialize(), nonceRFC6979, extra, version)
	if err != nil {
		return nil, nil, err
	}
...
func schnorrPartialSign(curve *secp256k1.KoblitzCurve, msg []byte, priv []byte, privNonce []byte, pubSum *secp256k1.PublicKey, hashFunc func([]byte) []byte) (*Signature, error) {
	// Sanity checks.
...
func PartialSign(curve *secp256k1.KoblitzCurve, msg []byte, priv *secp256k1.PrivateKey, privNonce *secp256k1.PrivateKey, pubSum *secp256k1.PublicKey) (*Signature, error) {
	...
	return schnorrPartialSign(curve, msg, privBytes, privNonceBytes, pubSum, sha3.Hash256)
}
...
func schnorrCombineSigs(curve *secp256k1.KoblitzCurve, sigss [][]byte) (*big.Int, error) {
