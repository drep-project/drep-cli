...
import (
	...
	"github.com/drep-project/drepcli/core/ethcrypto"
	"github.com/drep-project/drepcli/core/ethcrypto/bn256"
...
func (c *ecrecover) Run(input []byte) ([]byte, error) {
	...
	pubKey, err := ethcrypto.Ecrecover(input[:32], append(input[64:128], v))
