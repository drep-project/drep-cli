...
import (
	...
	jsre "github.com/drep-project/drepcli/drepclient/component/jsre"
	rpcConponent "github.com/drep-project/drepcli/rpc/component"
...
type Config struct {
	...
	Client   *rpcConponent.Client  // RPC client to execute Ethereum requests through
